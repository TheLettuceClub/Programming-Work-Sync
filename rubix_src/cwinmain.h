...
extern void print6x8     (tiletype *dd, int ox, int y, long fcol, long bcol, const char *fmt, ...);
extern void drawpix      (tiletype *dd, int x, int y, long col);
extern void drawhlin     (tiletype *dd, int x0, int x1, int y, long col);
extern void drawline     (tiletype *dd, float x0, float y0, float x1, float y1, long col);
extern void drawcirc     (tiletype *dd, int xc, int yc, int r, long col);
extern void drawrectfill (tiletype *dd, int x0, int y0, int x1, int y1, long col);
extern void drawcircfill (tiletype *dd, int xc, int yc, int r, long col);
